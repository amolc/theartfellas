...
<?php include('header_artist_thumbnail.php'); //get_header(); ?>
		...
		<!--<div style='font-size: 45px;font-family: "Times New Roman";'>View all artist in alphabetical order<a href="http://apps.fountaintechies.com/theartfellas/?page_id=3495"> here</a></div>-->
		<br />
        ...
        <div id="controls" class="load-item">
            ...
            <div id="portfolio_container" style="margin-top: -22px;" class="black_a_white">
